...
class Admin extends CI_Controller {
    ...
    public function index()
    {
        ...
        {  
            $website_info = $this->website_model->get_single_data();
            
            foreach ($website_info as $vrow)
            {
                $website_full_name = $vrow->website_name;
                $website_short_name=$vrow->website_short_name;
                $header_logo =$vrow->header_logo;
                $this->session->set_userdata('website_name',$website_short_name);
                $this->session->set_userdata('website_logo',$header_logo);
                $this->session->set_userdata('website_full_name',$website_full_name);
            }
