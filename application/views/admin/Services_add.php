...
<h6 class="card-title">Services </h6>
 ...
 <?php  echo form_open_multipart('Services/creting_Services' ,'class="needs-validation" novalidate'); ?>
     ...
     <div class="col-md-6" style="padding: 20px;">
      <div class="row">
       ...
       <div class="col-md-2 col-6">
       	<img src="<?php echo base_url()?>public/img/services/services_icon.jpg" id="pre_profile" 
      ...
      <div class="row">
       ...
       <div class="col-md-2 col-6">
       	<img src="<?php echo base_url()?>public/img/services/service_big.jpg" id="uploadPreview" 
