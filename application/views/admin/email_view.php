        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title"> Mailing List </h6>
                            <div class="table-responsive">
				 			    ...
				 			    <tr>
                                        ...
                                        <td> <?php echo $row->mailing_for; ?></td>
                                        <td> <?php echo $row->admin_email_to; ?>  </td>
                                        <td> <?php echo $row->headers_email; ?></td>
                                       
                                       
                                      <th><a  title="View Details" href="<?php echo base_url()."Mailing/edit/".$t_id;?>" 
                                      		class="btn btn-primary btn-floating btn-sm">
  											<i data-feather="edit-3" ></i></a>  
  											<a  title="Delete" href="<?php echo base_url()."Mailing/delete_mail/".$t_id;?>" 
  											class="btn btn-secondary btn-google btn-floating  btn-sm">
  											<i class="ti-trash"></i>  </a> 
  								  	  </th>
                                             <td>
                                    <?php if ($status == 1){ ?>
                                            <a href="<?php echo base_url()."Mailing/status/".$t_id."/0"?>">  
                                            <span class="badge badge-success">Active</span></a>  
                   							<?php } else {?>
                   						<a href="<?php echo base_url()."Mailing/status/".$t_id."/1";?>">
