...
<head>
    ...
    <title> Get Support  Inquiry </title>
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title">Get Support Inquiry  View </h6>
                            <div class="table-responsive">
				 			    ...
				 			    <tr>
                                         ...
                                         <td> <?php echo $t_id; ?></td>
                                        <td> <?php echo substr($row->g_name,0,20); ?></td>
                                        <td> <?php echo substr($row->g_email,0,30); ?>  </td>
                                        <td> <?php echo substr($row->g_mobno,0,14); ?></td>
                                        <td> <?php echo substr($row->g_message,0,34); ?></td>
                                         <td> <?php echo date("d-M-Y",strtotime($row->g_date));  ?></td>
                                      <th> 
                                      <a  title="View Details" href="<?php echo base_url()."Inquiry/getsupport_details/".$t_id;?>" 
                                      		class="btn btn-primary btn-floating btn-sm">
  											<i class="ti-view-list"></i></a>  
                                        
  											<a  title="Delete" href="<?php echo base_url()."Inquiry/delete_getsupport/".$t_id;?>" 
