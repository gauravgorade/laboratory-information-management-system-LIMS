...
<head>
    ...
    <title>Swasthyam Wellness Packages Inquiry details</title>
...
<?php   $this->load->view('admin/file/header')?>
    ...
    <div class="page-header">
        <div>
            <h3>Swasthyam Wellness Packages Inquiry details</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    Packages Inquiry List </a>
                    </li>
                    <li class="breadcrumb-item active">
                        <a href="#"> 
 					Wellness Packages Product Inquiry Full Details </a>
                    </li>
                </ol>
            </nav>
        </div>
            ...
            <div class="row">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <h6 class="card-title mb-2">Wellness Packages Product Inquiry  Details</h6>
                    ...
                    <div>
                      <?php 
                            ...
                            <div class="row list-group-item d-flex justify-content-between align-items-center px-0">
                                ...
                                <h3 class="text-success mb-0 float-right"> <?php echo $row->name; ?></h3>
                            	</div>
                            </div>
                            <div class="row list-group-item d-flex justify-content-between align-items-center px-0">
                                <div class="col-md-2 col-12">
                            ...
                            <div class="row list-group-item d-flex justify-content-between align-items-center px-0">
                                ...
                                <div class="col-md-10 col-12">
                                    <h3 class="text-info mb-0 float-right"><?php echo $row->mobile; ?></h3>
                                </div>
                            </div>
                             <div class="row list-group-item d-flex justify-content-between align-items-center px-0">
                                <div class="col-md-2 col-12">
                                    <h5> Inquiry for Packages </h5>
