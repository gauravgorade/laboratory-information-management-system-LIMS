...
<head>
    ...
    <title>Wellness Packages Product Inquiry</title>
...
<?php   $this->load->view('admin/file/header')?>
    ...
    <div class="page-header">
        <div>
            <h3>Wellness Packages Product Inquiry Export </h3>
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
  				   <div class="card">
                        <div class="card-body">
                            <h6 class="card-title">Wellness Packages Product Inquiry Export  </h6>
                            
                           <?php  echo form_open_multipart('Inquiry/export'); ?>
   ...
   <div class="invalid-tooltip">   Please Enter Password.  </div>
     ...
     <?php  echo form_close();?>
     <br>  <br>
       <h6 class="card-title">Wellness Packages Product Inquiry Export  
       ...
       ?>
				 			    ...
				 			    <tr>
                                        ...
                                        ?></td>
                                      <th><a  title="View Details" href="<?php echo base_url()."Inquiry/inquiry_details/".$t_id;?>" 
