...
<head>
    ...
    <title>Swasthyam Wellness Packages Inquiry </title>
...
<?php   $this->load->view('admin/file/header')?>
    ...
    <div class="page-header">
        <div>
            <h3>Wellness Packages Inquiry View</h3>
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title">Swasthyam Wellness Packages Inquiry View </h6>
                            <div class="table-responsive">
				 			    ...
				 			    <tr>
                                      ...
                                      <th><a  title="View Details" href="<?php echo base_url()."Inquiry/inquiry_details/".$t_id;?>" 
  											...
  											<a  title="Delete" href="<?php echo base_url()."Inquiry/delete_inquiry/".$t_id;?>" 
