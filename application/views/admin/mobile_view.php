...
<head>
    ...
    <title>Contact Mobile Number List</title>
...
<?php   $this->load->view('admin/file/header')?>
    ...
    <div class="page-header">
        <div>
            <h3>Contact Mobile Number List</h3>
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title">Contact Mobile Number List View </h6>
                            ...
                            <thead>
				 			    ...
				 			    <tr>
                                        ...
                                        <td> <?php echo substr($row->t_name,0,30); ?></td>
                                         <td> <?php echo substr($row->t_mobno,0,12); ?></td>
                                          <td> <?php  echo date("d-M-Y",strtotime($row->t_date));
                                       ?></td>
                                      <td>  <?php
                   							   $verify = $row->verify;
                                             ...
                                             <td>
                                              <?php if ($status == 1){ ?>
                                            <a href="<?php echo base_url()."Contact/contactlist_status/".$t_id."/0"?>">  
                                            <span class="badge badge-success">Active</span></a>  
                   							<?php } else {?>
                   						<a href="<?php echo base_url()."Contact/contactlist_status/".$t_id."/1";?>">
                   						   <span class="badge badge-danger">Deactivate  </span></a>  
                   							   <?php }?>
                   							   
                   							   <a  title="Delete" href="<?php echo base_url()."Contact/delete_contactlist/".$t_id;?>" 
