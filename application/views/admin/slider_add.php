        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="<?php echo base_url();?>Slider/view">Slider View</a>
                    </li>
...
<h6 class="card-title">Slider </h6>
 ...
 <?php  echo form_open_multipart('Slider/creting_slider' ,'class="needs-validation" novalidate'); ?>
   ...
   <div class="form-row">
      ...
      <div class="col-md-6 mb-3">
         ...
         <input name="sub_heading" id="sub_heading"  type="text" class="form-control" >
      ...
      <div class="col-md-6">
         ...
         <input name="paragraph1" id="paragraph1"  type="text" class="form-control" 
             >
         <div class="invalid-tooltip">
       ...
       <div class="col-md-6 d-none">
         ...
         <input name="paragraph2" id="paragraph2"  type="text" class="form-control">
         <div class="invalid-tooltip">
       ...
       <div class="col-md-6 d-none">
         ...
         <input name="button_link1" id="button_link1"  type="text" class="form-control">
         <div class="invalid-tooltip">
       ...
       <div class="col-md-6 d-none">
         ...
         <input name="button_link2" id="button_link2"  type="text" class="form-control">
         <div class="invalid-tooltip">
      ...
      <div class="row">
       <div class="col-md-8">
       <label for="userImage">Select Slider Image <code> Width=1933px; and Height=1017px  Max Image Size 2MB 
 		 	   </code></label>
       ...
       <div class="col-md-2">
       	<img src="<?php echo base_url()?>public/img/slider.png" id="pre_profile" 
