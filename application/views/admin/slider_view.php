            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">
                        <a href="<?php echo base_url();?>Slider/view">View Slider</a>
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title">View homepage Slider  </h6>
                            <div class="table-responsive">
                                 ...
                                 <?php 
                                    	foreach ($result as $row) {  
                                    	    $t_id = $row->slider_id;  $status = $row->status;  ?>
				 			    <tr>
                                        
                                        
                                        <th>  <figure class="avatar avatar-xl">
											<img src="<?php echo  base_url()."public/img/slider/".$row->img_path;?>"   alt="image">  </figure>
                                         </th>
                                        <td> <?php echo $row->heading; ?></td>
                                        <td> <?php echo $row->sub_heading; ?></td>
                                        
                                       
                                      <th><a href="<?php echo base_url()."Slider/edit/".$t_id;?>"      class="btn btn-primary btn-floating btn-sm">
  											<i class="ti-pencil-alt"></i></a>  
  											<a href="<?php echo base_url()."Slider/delete/".$t_id;?>" class="btn btn-secondary btn-google btn-floating  btn-sm">
  											<i class="ti-trash"></i>  </a> 
  								  	  </th>
                                             <td>
                                             <?php if ($status == 1){ ?>
                                            <a href="<?php echo base_url()."Slider/status/".$t_id."/0"?>">  
                                            <span class="badge badge-success">Active</span></a>  
                   							<?php } else {?>
                   						<a href="<?php echo base_url()."Slider/status/".$t_id."/1";?>">
