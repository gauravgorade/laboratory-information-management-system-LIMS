...
<?php   $this->load->view('admin/file/header')?>
    ...
    <div class="page-header">
        <div>
            <h3>Newsletter Subscribers  View</h3>
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title">Newsletter Subscribers List </h6>
                            ...
                            <thead>
                                 ...
                                 <?php 
                                    	foreach ($result as $row) {  
                                    	    $t_id = $row->sb_id;  $status = $row->status;
                                    	    $status = $row->status;?>
				 			    <tr>
                                       <td> <?php echo $t_id; ?>  </td>
                                       ...
                                       ?></td>
                                             ...
                                             <td>
                                              <?php if ($status == 1){ ?>
                                            <a href="<?php echo base_url()."Website/status/".$t_id."/0"?>">  
                                            <span class="badge badge-success">Active</span></a>  
                   							<?php } else {?>
                   						<a href="<?php echo base_url()."Website/status/".$t_id."/1";?>">
                   						   <span class="badge badge-danger">Deactivate  </span></a>  
                   							   <?php }?>
               							
                                            <a  title="Delete" href="<?php echo base_url()."Website/delete_newslatterc/".$t_id;?>" 
