            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">
                        <a href="<?php echo base_url();?>Testimonial/view_testimonial">View Testimonial</a>
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title">Testimonial Or Success story</h6>
                            <div class="table-responsive">
				 			    ...
				 			    <tr>
                                        ...
                                        <th align="center">  <figure class="avatar avatar-sm">
											<img src="<?php echo  base_url()."public/img/client/".$row->img_path;?>" class="rounded-circle" alt="image">  </figure>
                                         </th>
                                        <td> <?php echo $row->full_name; ?></td>
                                        <td> <?php echo $row->thought; ?></td>
                                        <td> <?php echo $row->c_desc; ?></td>
                                       
                                      <th><a href="<?php echo base_url()."Testimonial/edit/".$t_id;?>"      class="btn btn-primary btn-floating btn-sm">
  											<i class="ti-pencil-alt"></i></a>  
  											<a href="<?php echo base_url()."Testimonial/delete_testimonial/".$t_id;?>" class="btn btn-secondary btn-google btn-floating  btn-sm">
  											<i class="ti-trash"></i>  </a> 
  								  	  </th>
                                             <td>
                                             <?php if ($status == 1){ ?>
                                            <a href="<?php echo base_url()."Testimonial/status/".$t_id."/0"?>">  
                                            <span class="badge badge-success">Active</span></a>  
                   							<?php } else {?>
                   						<a href="<?php echo base_url()."Testimonial/status/".$t_id."/1";?>">
