                            ...
                            <div class="table-responsive">
				 			    ...
				 			    <tr>
                                        ...
                                        <th align="center">  <figure class="avatar avatar-sm">
											<img src="<?php echo  base_url()."public/img/".$row->profile;?>" class="rounded-circle" alt="<?php echo $row->profile;?>">  </figure>
                                         </th>
                                      ...
                                      <th>
                                      <?php if ($admin_type !='1') {?>
                                      <a href="<?php echo base_url()."Users/edit/".$t_id;?>"      class="btn btn-primary btn-floating btn-sm">
