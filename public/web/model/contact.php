...
if(isset($_POST['name']) && isset($_POST['email']) && isset($_POST['message']))
{
	...
	$insertQuery="INSERT INTO contact(c_name,c_email,c_message,c_date,c_status) VALUES ('$name','$email','$message',now(),'No')";
	mysqli_query($con,$insertQuery);
	
	$addings ="SELECT * FROM subscribe_email WHERE s_email='$email'";
    $resultsub = mysqli_query($con,$addings);
    if(mysqli_num_rows($resultsub) == 0)
    {
	$insertQuery123="INSERT INTO subscribe_email(s_email,s_status,s_date) VALUES ('$email','Yes',now())";
			...
			<div class="contentmid">
				<div style="font-size:1em;">
					...
					<table style="margin:auto;padding-left:30px;padding-right:30px;">
						...
						<tr>
							<td style="text-align:right;"><b class="fonthead">Name</b></td><td style="text-align:center;">&nbsp;&nbsp;:&nbsp;&nbsp;</td><td style="text-align:left;">'.$name.'</td>
						</tr>
						<tr>
							<td style="text-align:right;"><b class="fonthead">Email</b></td><td style="text-align:center;">&nbsp;&nbsp;:&nbsp;&nbsp;</td><td style="text-align:left;">'.$email.'</td>
						</tr>
						<tr>
							<td style="text-align:right;"><b class="fonthead">Message</b></td><td style="text-align:center;">&nbsp;&nbsp;:&nbsp;&nbsp;</td><td style="text-align:left;">'.$message.'</td>
						</tr>
					</table>
