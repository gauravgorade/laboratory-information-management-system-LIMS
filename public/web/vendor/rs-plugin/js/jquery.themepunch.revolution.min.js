...
!(function(jQuery, undefined) {
    ...
    var _ISM = _R.is_mobile(),
        ...
        checkIDS = function(e, i) {
            if (
                ((e.anyid = e.anyid === undefined ? [] : e.anyid), -1 != jQuery.inArray(i.attr("id"), e.anyid))
            ) {
        ...
        runSlider = function(e, i) {
            ...
            if (
                (i.shadow !== undefined &&
                    ...
                    setCurWinRange(i),
                    setCurWinRange(i, !0), !e.hasClass("revslider-initialised"))
            ) {
        ...
        containerResized = function(e, i) {
            if (
                (e.trigger("revolution.slide.beforeredraw"),
                    ...
                    setCurWinRange(i),
                    setCurWinRange(i, !0), !_R.resizeThumbsTabs || !0 === _R.resizeThumbsTabs(i))
            ) {
                if (
                        ...
                        if ((t.attr("src", r.src), "img" == r.type))
                            if (t.hasClass("defaultimg"))
                                ...
                                t.data("owidth", r.width),
                                    ...
                                    (s = s == undefined || "auto" == s || "" == s ? r.height : s), !jQuery.isNumeric(o) && o.indexOf("%") > 0 && (s = o),
                                    t.data("ww", o),
                                    t.data("hh", s);
                            }
                        else
        ...
        swapSlide = function(e) {
            ...
            !0 === i.onlyPreparedSlide &&
                ...
                a.removeClass("next-revslide").addClass("processing-revslide"), -1 === a.index() &&
                "carousel" === i.sliderType &&
                (a = jQuery(i.li[0])),
                a.data(
    ...
    jQuery.extend(!0, t, {
        ...
        prepareSingleCaption: function(e) {
            ...
            if (
                ...
                "off" !== a._responsive ?
                    ("grid" != a._ba && u ?
                        ...
                        l.css({ height: c }) :
                        jQuery.isNumeric(c) ?
                        l.css({ height: c * n.bh + "px" }) :
                        l.css({ height: c })) :
                    l.css({ width: m, height: c }),
                    a._ingroup &&
                    "row" !== a._nctype &&
                    (void 0 !== m &&
                        !jQuery.isNumeric(m) &&
                        ...
                        m.indexOf("%") > 0 &&
                        punchgs.TweenLite.set([a._lw, a._pw, a._mw], { minWidth: m }),
                        void 0 !== c &&
                        !jQuery.isNumeric(c) &&
                        "string" === jQuery.type(c) &&
                        c.indexOf("%") > 0 &&
                        punchgs.TweenLite.set([a._lw, a._pw, a._mw], { minHeight: c }));
            }
            ...
            if (
                ...
                if (
                    ((a.layertype = "video"),
                        t.manageVideoLayer && t.manageVideoLayer(i, n, r, o), !r && !o)
                ) {
                    a.videotype;
            ...
            a._ingroup &&
                ...
                (void 0 !== a._groupw &&
                    ...
                    a._groupw.indexOf("%") > 0 &&
                    punchgs.TweenLite.set([a._lw, a._pw, a._mw], { minWidth: a._groupw }),
                    void 0 !== a._grouph &&
        ...
        createTimelineStructure: function(e) {
            ...
            e.c.find(".tp-revslider-slidesli, .tp-static-layers").each(function() {
                ...
                t.find(".tp-caption").each(function(t) {
                    ...
                    (r = i),
                    (s = new punchgs.TimelineLite({ paused: !0 })),
        ...
        buildFullTimeLine: function(e) {
            var i,
                ...
                d = {},
                l = g();
            if (!(i = s.timelines[r._slideid].layers[r._id]).generated ||
                !0 === e.regenerate
            ) {
                if (
                    ((a = i.timeline),
                        ...
                        ((r.idlesvg = c(r.svg_idle, m())),
                            punchgs.TweenLite.set(d.svg, r.idlesvg.anim)), -1 !== r.hoverframeindex &&
                    ...
                    n.hover(
                        function(e) {
                            ...
                            ((a.basiczindex =
                                ...
                                (a.hovertimelines.pwhoveranim = punchgs.TweenLite.to(
                                    a._pw,
                                    n.speed / 1e3, { overwrite: "auto", zIndex: a.hoverzIndex }
                                )),
                        ...
                        function(e) {
                            ...
                            a.hovertimelines.item.pause(),
                                ...
                                (a.hovertimelines.pwhoveranim = punchgs.TweenLite.to(
                                    a._pw,
                                    n.speed / 1e3, { overwrite: "auto", zIndex: a.basiczindex }
                                )),
                                d.svg &&
        ...
        createFrameOnTimeline: function(e) {
            var t = e.caption,
                ...
                k = !1;
            if (
                ((x = void 0 === x ? "forward" : x), -1 !== i.hoverframeindex && i.hoverframeindex == y && (y -= 1),
                    (_.content = new punchgs.TimelineLite({ align: "normal" })),
                    (_.mask = new punchgs.TimelineLite({ align: "normal" })),
            ...
            if (0 !== c || e.fromcurrentstate)
                if ("block" === i._sfx_out && c === i.outframeindex)
                    m.add(_.content.staggerTo(u, 0.001, { autoAlpha: 0, delay: O }), o),
                    m.add(
                ...
                m.add(
                    _.content.staggerFromTo(
                        u,
                        0.05, { x: 0, y: 0, autoAlpha: 0 }, { x: 0, y: 0, autoAlpha: 1, delay: O }
                    ),
                    o
                );
            else if (k && void 0 !== P) {
                var F = { from: d(R.anim), to: d(W.anim) };
                for (var A in u) {
            ...
            return (
                ...
                0 === c && m.add(_.mask.set(i._mw, { overflow: "visible" }), o),
            ...
            if (
                (void 0 !== e.frame ?
                    ...
                    ((i.outnow = new punchgs.TimelineLite()),
                        i.timeline.pause(), !0 === a.visibleelement &&
                        t
            ...
            r &&
                jQuery.each(r, function(e) {
                    ...
                    "carousel" === a.sliderType && "on" === a.carousel.showLayersAllTime ?
                        ...
                        (I(i),
                            clearTimeout(i.data("videoplaywait")),
                            t.endMoveCaption({ caption: i, opt: a, currentslide: o }),
                            t.removeMediaFromList && t.removeMediaFromList(i, a),
                            (a.lastplayedvideos = []));
                });
        },
    ...
    var a = function(e, i, a, n, r, o, s, d, l) {
        ...
        n = function(e, t, i, a, n, r, o, s, d, l) {
            "column" === a._nctype && j(d, l),
                ...
                ((a._gsTransformTo = o),
                    ...
                    (a._gsTransformTo = jQuery.extend(!0, {},
                        a.cssobj.styleProps,
                        a._gsTransformTo
                    )) :
                    (a._gsTransformTo = jQuery.extend(!0, {},
        ...
        r = function(e, i, a, n, r, o, s, d, l) {
            ...
            l.c.trigger("revolution.layeraction", [m]),
                ...
                ((r.active = !1),
                    punchgs.TweenLite.set(n, { visibility: "hidden", overwrite: "auto" }),
                    (r.animdirection = "out"),
                    (r.visibleelement = !1),
        ...
        L = function(e, t) {
            ...
            if (e.hasClass("rs-pendulum") && null == i._loop_timeline) {
                ...
                i._loop_timeline.append(
                        new punchgs.TweenLite.fromTo(
                            e,
                            r, { force3D: "auto", rotation: a, transformOrigin: o }, { rotation: n, ease: s }
                        )
                    ),
                    i._loop_timeline.append(
                        new punchgs.TweenLite.fromTo(
            ...
            if (e.hasClass("rs-slideloop") && null == i._loop_timeline) {
                ...
                i._loop_timeline.append(
                        new punchgs.TweenLite.fromTo(
                            e,
                            r, { force3D: "auto", x: d, y: l }, { x: m, y: c, ease: s }
                        )
                    ),
                    i._loop_timeline.append(
                        new punchgs.TweenLite.fromTo(
            ...
            if (e.hasClass("rs-pulse") && null == i._loop_timeline) {
                ...
                i._loop_timeline.append(
                        new punchgs.TweenLite.fromTo(
                            e,
                            r, { force3D: "auto", scale: p }, { scale: g, ease: s }
                        )
                    ),
                    i._loop_timeline.append(
                        new punchgs.TweenLite.fromTo(
            ...
            if (e.hasClass("rs-wave") && null == i._loop_timeline) {
                ...
                var _ = {
                    ...
                    y = new punchgs.TweenLite.fromTo(
                        _,
                        r, { a: 0 + b }, { a: 360 + b, force3D: "auto", ease: punchgs.Linear.easeNone }
                    );
                y.eventCallback(
                        "onUpdate",
                        function(e) {
    ...
    var e = function(a, b) {
        ...
        f = function(a, b, c, d, e, f) {
            var g = c.parent().find(".tp-" + f + "s"),
                ...
                n =
                "vertical" === d.direction ? { width: j + "px" } : { height: k + "px" };
        ...
        j = function(a, b, d) {
            return (
                (a = c ?
                    ...
                    jQuery(d.originalTarget).closest("." + a).length), !0 === a || 1 === a ? 1 : 0
            );
        },
        k = function(a, d, e) {
            var f = d.carousel;
        ...
        o = function(a, b) {
            ...
            n(b.navigation.arrows) &&
                punchgs.TweenLite.delayedCall(
                    ...
                    p, [d.find(".tparrows"), b.navigation.arrows, "hide"]
                ),
                ...
                punchgs.TweenLite.delayedCall(
                    ...
                    p, [d.find(".tp-bullets"), b.navigation.bullets, "hide"]
                ),
                ...
                punchgs.TweenLite.delayedCall(
                    ...
                    p, [d.find(".tp-thumbs"), b.navigation.thumbnails, "hide"]
                ),
                n(b.navigation.tabs) &&
                punchgs.TweenLite.delayedCall(
                    c ?
                    ...
                    p, [d.find(".tp-tabs"), b.navigation.tabs, "hide"]
                );
        },
        p = function(a, b, c, d) {
        ...
        t = function(a, b, c) {
            ...
            if (
                ...
                h > e && "outer-left" !== b.position && "outer-right" !== b.position ?
                    ...
                    "outer-left" !== b.position &&
                    "outer-right" !== b.position &&
                    ((k = 0), (l = 0)), !0 === b.span && "vertical" === b.direction ?
                    (punchgs.TweenLite.set(a, {
                            maxHeight: k + l + (f - 2 * g) + "px",
                            height: k + l + (f - 2 * g) + "px",
                            top: 0 - k,
        ...
        g = function(a, b, c, g, h, i, j, k) {
                ...
                setTimeout(function() {
                    ...
                    i.find(".slotslide").each(function(a) {
                        ...
                        A.add(
                                punchgs.TweenLite.fromTo(
                                    b,
                                    t / 1e3, { left: 0, top: 0, opacity: 0, transformPerspective: 600 }, {
                                        left: 0 - a * l.slotw + "px",
                                        ease: v,
                                        force3D: "auto",
                                        top: "0px",
                ...
                j.find(".slotslide").each(function() {
                    ...
                    i.find(".slotslide").each(function(a) {
                        ...
                        A.add(
                                punchgs.TweenLite.fromTo(
                                    b,
                                    t / 1e3, { left: 0, top: 0, opacity: 0, force3D: "auto" }, {
                                        left: "0px",
                                        top: 0 - a * l.sloth + "px",
            ...
            if (9 == a || 10 == a) {
                ...
                i.find(".slotslide").each(function(a) {
                    ...
                    k.add(
                        punchgs.TweenLite.fromTo(
                            b,
                            t / 2e3, { autoAlpha: 0, force3D: "auto", transformPerspective: 600 }, { autoAlpha: 1, ease: u, delay: (a * l.slots) / 100 / 2e3 }
                        ),
                        0
                    );
                });
            ...
            if (31 == a || 32 == a || 33 == a || 34 == a) {
                ...
                k.add(
                        punchgs.TweenLite.fromTo(
                            j,
                            U - 0.2 * U, { y: 0, x: 0 }, { y: ty, x: tx, ease: v }
                        ),
                        0.2 * U
                    ),
                    k.add(
                ...
                switch (r) {
                    case 0:
                        k.add(
                            punchgs.TweenLite.fromTo(
                                i,
                                t / 1e3, { autoAlpha: 0 }, { autoAlpha: 1, force3D: "auto", ease: u }
                            ),
                            0
                        );
                        break;
                    case 1:
                        k.add(
                            ...
                            k.add(
                                punchgs.TweenLite.fromTo(
                                    j,
                                    t / 1e3, { autoAlpha: 1 }, { autoAlpha: 0, force3D: "auto", ease: u }
                                ),
                                0
                            );
                        break;
                    ...
                    case 4:
                        k.add(
                            ...
                            k.add(
                                punchgs.TweenLite.fromTo(
                                    i,
                                    t / 2e3, { autoAlpha: 0 }, { autoAlpha: 1, force3D: "auto", ease: u }
                                ),
                                t / 2e3
                            );
                        break;
                    ...
                    case 12:
                        ...
                        k.add(
                                punchgs.TweenLite.fromTo(
                                    i,
                                    t / 1e3, { autoAlpha: 0, filter: $, "-webkit-filter": $ }, {
                                        autoAlpha: 1,
                                        filter: _,
                                        "-webkit-filter": _,
                                        force3D: "auto",
                            ...
                            k.add(
                                punchgs.TweenLite.fromTo(
                                    j,
                                    t / 1e3, { autoAlpha: 1, filter: _, "-webkit-filter": _ }, {
                                        autoAlpha: 0,
                                        force3D: "auto",
                                        ease: u,
                                        filter: $,
                    ...
                    j.find(".slotslide").each(function(b) {
                        ...
                        k.add(
                            ...
                            k.add(
                                punchgs.TweenLite.fromTo(
                                    c,
                                    t / 2e3, { autoAlpha: 1 }, { autoAlpha: 0, delay: (50 * b) / 500 + t / 3e3, ease: v }
                                ),
                                0
                            );
                    });
                ...
                case "youtube":
                    if (0 == e.find("iframe").length)
                        ...
                        1 == e.data("nextslideatend-triggered") &&
                            ((n = -1), e.data("nextslideatend-triggered", 0)), -1 != r && r > n && o.player.seekTo(r), !0 !== o.youtubepausecalled && o.player.playVideo();
                    } else
                        e.data(
                            "videoplaywait",
                            setTimeout(function() {
                    ...
                    if (0 == e.find("iframe").length)
                        ...
                        e.data("vimeoplayer") ?
                            ...
                            setTimeout(function() {
                                ...
                                i || (i = 0),
                                    1 == e.data("nextslideatend-triggered") &&
                                    ((i = -1), e.data("nextslideatend-triggered", 0)), -1 != a && a > i && l.setCurrentTime(a),
                                    l.play();
                            }, 510) :
                            e.data(
                                "videoplaywait",
                ...
                case "html5":
                    ...
                    if (1 != v.parent().data("metaloaded"))
                        d(
                            ...
                            (function(e) {
                                ...
                                var o = t(e.data("videostartat")),
                                    d = c.currentTime;
                                1 == e.data("nextslideatend-triggered") &&
                                    ((d = -1), e.data("nextslideatend-triggered", 0)), -1 != o && o > d && (c.currentTime = o);
                            })(e)
                        );
                    else {
                        c.play();
                        var r = t(e.data("videostartat")),
                            n = c.currentTime;
                        1 == e.data("nextslideatend-triggered") &&
                            ((n = -1), e.data("nextslideatend-triggered", 0)), -1 != r && r > n && (c.currentTime = r);
                    }
            }
        },
                ...
                switch (s.videotype) {
                    ...
                    case "vimeo":
                        ...
                        L.on("loaded", function(t) {
                            ...
                            e.data("startvideonow") &&
                            (L.play(), -1 != (_ = t(e.data("videostartat"))) && L.setCurrentTime(_)),
                            e.data("videolistenerexist", 1);
                }
            else {
                var _ = t(e.data("videostartat"));
